...
if (Meteor.isServer) {
  describe('FavoritesCollection', function testSuite() {
    ...
    const defineObject = { firstName, lastName, username, favorites, bio, picture, title };
    ...
    it('#define (illegal interest)', function test() {
      ...
      const defineObject2 = { firstName, lastName, username, favorites, bio, picture, title };
    ...
    it('#define (duplicate interests)', function test() {
      ...
      const defineObject3 = { firstName, lastName, username, favorites, bio, picture, title  };
